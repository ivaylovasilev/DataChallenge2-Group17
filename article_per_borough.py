...
def query_london():
    ...
    SELECT GlobalEventID, SQLDATE, MonthYear, Actor1Name, Actor2Name, Actor1CountryCode, Actor2CountryCode,
           EventCode, NumMentions, NumSources, NumArticles, AvgTone, SOURCEURL, ACTOR1GEO_LAT, ACTOR1GEO_LONG
    ...
    WHERE (Actor1Name LIKE '%POLICE%' AND Actor2Name LIKE '%LONDON%' OR
          ...
          AND Actor1Geo_Lat BETWEEN  51.510435842437566 AND 51.59858911654411
          AND Actor1Geo_Long BETWEEN 0.06527168162318163 AND 0.19239966983062606
...
if __name__ == "__main__":
    ...
    processed_df.to_csv('Barking_and_Dagenham_weekly.csv')
